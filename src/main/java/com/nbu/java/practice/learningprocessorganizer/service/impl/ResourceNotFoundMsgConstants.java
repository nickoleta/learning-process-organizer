...
public final class ResourceNotFoundMsgConstants {
    ...
    public static final String FILE_DOES_NOT_EXIST = "Lecturer with id %s does not exist!";

    private ResourceNotFoundMsgConstants() {
    }
